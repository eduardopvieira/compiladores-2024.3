...
_lr_productions = [
  ...
  ('outra_classe -> CLASSE','outra_classe',1,'p_outra_classe','analisadorLexico.py',87),
  ('outra_classe -> CLASSE CARACTERE_ESPECIAL outra_classe','outra_classe',3,'p_outra_classe','analisadorLexico.py',88),
  ('caso_individuals -> PALAVRA_RESERVADA NOME_INDIVIDUO','caso_individuals',2,'p_caso_individuals','analisadorLexico.py',95),
  ('caso_individuals -> PALAVRA_RESERVADA NOME_INDIVIDUO CARACTERE_ESPECIAL outro_individuo','caso_individuals',4,'p_caso_individuals','analisadorLexico.py',96),
  ('outro_individuo -> NOME_INDIVIDUO','outro_individuo',1,'p_outro_individuo','analisadorLexico.py',103),
  ('outro_individuo -> NOME_INDIVIDUO CARACTERE_ESPECIAL outro_individuo','outro_individuo',3,'p_outro_individuo','analisadorLexico.py',104),
]
