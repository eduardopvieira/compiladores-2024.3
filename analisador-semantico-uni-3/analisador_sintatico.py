...
tokens = [
    ...
    "OR", "AND", "SOME", "ONLY", "VALUE", "PALAVRA_CLASS"
]
...
def p_declaracao_classe_primitiva(p):
    ...
    #     p[0] = [p[2], p[4]]
    # elif len(p) == 6:
    #     p[0] = ['declaracao_classe_primitiva', p[2], p[4], p[5]]
    # else: 
...
def executar_analisador(codigo):
    ...
    # arvore_sintatica = result
    # for token in arvore_sintatica:
    #     print(token)
